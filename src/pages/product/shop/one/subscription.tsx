	...
	return (
		<StyledMain className='container'>
			...
			<Link to = "/">
				...
				<p style={{fontSize: "14px"}}>Subscription</p>
			</div>
			...
			<section className='row'>
				<div className='col-lg-3 col-sm-12'>
					<div className='links'>
						...
						<div style={{padding: "0px 1em"}}>
							...
							<div className='categories'>
								<Link to={'/product/shop/one/offer'}> <p style={{paddingLeft: "2em"}}>PC Games</p> </Link>
							</div>
						...
						<div style={{padding: "1em"}}>
							<div className=''>
								<Link to={'/product/shop/one/subscription'}> <p style={{paddingLeft: "2em", fontWeight: "700"}}>Subscription</p></Link>
							</div>
						</div>
					</div>
				...
				<div className='col-lg-9 col-sm-12'>
					...
					<p style={{paddingBottom: "7px",fontSize: "1.2em"}}>Subscription</p>
