	...
	return (
		<StyledMain className='container'>
			...
			<Link to = "/">
				...
				<p style={{fontSize: "14px"}}>Gaming Consoles</p>
			</div>
			...
			<section className='row'>
					...
					<div className='links'>
						<div className='categories' style={{padding: "9px 0px"}}>
							...
							<div style={{padding: "1em"}}>
								<div className=''>
									<Link to={'/product/shop/one/gameing'}> <p style={{paddingLeft: "2em", fontWeight: "700"}}>Gaming Consoles</p></Link>
								</div>
							</div>
					</div>
				...
				<div className='col-lg-9 col-sm-12'>
					...
					<p style={{paddingBottom: "7px",fontSize: "1.2em"}}>Gaming Consoles</p>
