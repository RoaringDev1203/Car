	...
	return (
		<StyledMain className='container'>
			...
			<Link to = "/">
				...
				<p style={{fontSize: "14px"}}>PC Games</p>
			</div>
			...
			<section className='row'>
				<div className='col-lg-3 col-sm-12'>
					<div className='links'>
						...
						<div style={{padding: "1em"}}>
							<div className=''>
								<Link to={'/product/shop/one/pcgames'}> <p style={{paddingLeft: "2em", fontWeight: "700"}}>PC Games</p></Link>
							</div>
						</div>
					</div>
				...
				<div className='col-lg-9 col-sm-12'>
					...
					<p style={{paddingBottom: "7px",fontSize: "1.2em"}}>PC games</p>
