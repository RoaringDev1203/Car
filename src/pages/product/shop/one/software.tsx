	...
	return (
		<StyledMain className='container'>
			...
			<Link to = "/">
				...
				<p style={{fontSize: "14px"}}>Software</p>
			</div>
			...
			<section className='row'>
				<div className='col-lg-3 col-sm-12'>
					<div className='links'>
						...
						<div style={{padding: "1em"}}>
							<div className=''>
								<Link to={'/product/shop/one/software'}> <p style={{paddingLeft: "2em", fontWeight: "700"}}>Software</p></Link>
							</div>
						</div>
					</div>
				...
				<div className='col-lg-9 col-sm-12'>
					...
					<p style={{paddingBottom: "7px",fontSize: "1.2em"}}>Software</p>
