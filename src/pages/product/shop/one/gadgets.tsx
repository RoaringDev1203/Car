...
import { getTotalPage, showAlert } from '@/context/helper';
	...
	return (
		<StyledMain className='container'>
			...
			<Link to = "/">
				...
				<p style={{fontSize: "14px"}}>Gadgets</p>
			</div>
			...
			<section className='row'>
					...
					<div className='links'>
						<div className='categories' style={{padding: "9px 0px"}}>
							<Link to={'/product/shop/main'} className='d middle gap'> 
								<div className='showall' style={{fontSize: "0.9em", paddingLeft: "2em"}}> Show All Categories </div>
								<Icon icon='arr'></Icon>
							</Link>
						</div>
							<div className='category' style={{padding: "0px 1em"}}>
						...
						<div style={{padding: "1em"}}>
							<div className=''>
								<Link to={'/product/shop/one/gadgets'}> <p style={{paddingLeft: "2em", fontWeight: "700"}}>Gadgets</p></Link>
							</div>
						</div>
					</div>
				...
				<div className='col-lg-9 col-sm-12'>
					...
					<p style={{paddingBottom: "7px",fontSize: "1.2em"}}>Gadgets</p>
